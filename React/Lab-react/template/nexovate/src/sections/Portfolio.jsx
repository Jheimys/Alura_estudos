...
const Portfolio = () => {
  ...
  return (
    <div id='portfolio' className='w-full h-auto flex flex-col items-center justify-center lg:px-[80px] px-[20px] lg:py-[80px] py-[60px] gap-[20px] bg-cover bg-center' style={{ backgroundImage: `url(${backgroundimage})` }}> 
